		...
		<div class="post" id="registerDiv">
			...
			<form id="leForm" action="javascript:;" method="post">
				...
				<table>
					...
					<tr><td><p><fmt:message key="generic.text.senha" /><font color="red"><small>* </small></font>:</p></td><td><input type="password" id="passWord" autocomplete="off" minlength="8" maxlength="512" required/></td></tr>
