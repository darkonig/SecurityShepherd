			...
			<div id="content">
				<div class="setupPage">
					...
					<div class='input-group' style="margin-bottom: 15px;">
						<textarea id='theKey' style="font-size: 12px; padding:0.1em; height: 30px; display: inline-block; float: left; padding-right: 1em; overflow: hidden; width:95%">SETUP_PATH</textarea>
