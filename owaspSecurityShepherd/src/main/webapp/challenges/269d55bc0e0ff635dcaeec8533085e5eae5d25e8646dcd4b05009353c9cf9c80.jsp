	...
	<script type="text/javascript" src="../js/clipboard-js/clipboard-events.js"></script>
		<div id="contentDiv">
			...
			<p> 
				...
				<br />
				<form id="leForm" action="javascript:;" autocomplete="off" method="POST">
					<div id="resultsDiv">
						<table>
							<tr><td>
				...
				<div id="forgottenPassDiv" style="display: none;">
					<form id="leForm2" action="javascript:;" autocomplete="off" method="POST">
					...
					<form id="leForm3" action="javascript:;" autocomplete="off" method="POST">
						<table>
							<tr></td>
