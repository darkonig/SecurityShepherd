	...
	<script type="text/javascript" src="../js/clipboard-js/clipboard-events.js"></script>
		<div id="contentDiv">
			...
			<p> 
				...
				<br/>
				<br/>
				<%= StringEscapeUtils.escapeHtml4(bundle.getString("challenge.whereIdIsUserBeenIncremented.1")) %> <%= StringEscapeUtils.escapeHtml4(bundle.getString("challenge.userIdExample")) %> <%= StringEscapeUtils.escapeHtml4(bundle.getString("challenge.whereIdIsUserBeenIncremented.2")) %> <%= StringEscapeUtils.escapeHtml4(bundle.getString("challenge.yourIdIs")) %> <%= StringEscapeUtils.escapeHtml4(userId) %> <%=StringEscapeUtils.escapeHtml4(bundle.getString("challenge.yourCsrfTokenIs")) %> <a><%= StringEscapeUtils.escapeHtml4(csrfChal4Token) %></a><%= StringEscapeUtils.escapeHtml4(bundle.getString("challenge.yourIdIs.1")) %>
				<br/>
				<br/>
