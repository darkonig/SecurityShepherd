		...
		if(Validate.validateSession(ses))
		{
			...
			try
			{
				...
				else
				{
					...
					htmlOutput = "<h2 class='title'>" + bundle.getString("response.notFound") + "</h2><p>" + StringEscapeUtils.escapeHtml4(bundle.getString("response.notFoundMessage.1")) + " '" + Encode.forHtml(userId) + "' " + bundle.getString("response.notFoundMessage.2") + "</p>";
				}
